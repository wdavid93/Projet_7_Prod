...
#     # Vérifier que la réponse contient les clés attendues
#     assert 'status_famille' in data
#     assert 'nb_enfant' in data
#     assert 'age' in data
#     assert 'revenus' in data
#     assert 'montant_credit' in data
#     assert 'annuites' in data
#     assert 'montant_bien' in data

#     # Vous pouvez également effectuer des assertions spécifiques sur les valeurs si nécessaire
#     # assert isinstance(data['status_famille'], str)
#     # assert isinstance(data['nb_enfant'], int)
#     # assert isinstance(data['age'], int)
#     # assert isinstance(data['revenus'], float)
#     # assert isinstance(data['montant_credit'], float)
#     # assert isinstance(data['annuites'], float)
#     # assert isinstance(data['montant_bien'], float)
